const CACHE='adaptive-hoti0108-v2.2.0-activity-organizer';const PAGE_CACHE='adaptive-hoti0108-manual-pages-v2';
...
self.addEventListener('fetch',e=>{
 ...
 if(/\/content\/UF\d{4}\/pages\/\d+\.webp$/.test(new URL(e.request.url).pathname)){
