const CACHE='adaptive-hoti0108-v2.9.0-recommendations';const PAGE_CACHE='adaptive-hoti0108-manual-pages-v2';
const ASSETS=['./sprint.js','./exam-focus.js','./exam-focus.css','./quiz.css','./quiz-engine.js','./','./index.html','./app.js','./adrian-visual-system.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./data/manuals-index.json','./data/course-state.json','./data/activities-uf0049-source.json','./data/activity-recommendations.json','./data/questions-mf1074.json','./data/question-evidence.json','./data/progress-schema.json','./manuals.html','./manuals.css','./manuals.js','./documentation.js','./course-overview.js','./activities.html','./activity.html','./activities.css','./joti-chatgpt.js','./activities-list.js','./activity-detail.js'];
