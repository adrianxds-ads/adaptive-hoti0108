const CACHE='adaptive-hoti0108-v1.3-manual-audited';const PAGE_CACHE='adaptive-hoti0108-manual-pages-v1';
const ASSETS=['./quiz.css','./quiz-engine.js','./','./index.html','./app.js','./adrian-visual-system.js','./manifest.webmanifest','./icon.svg','./icon-192.png','./icon-512.png','./data/manuals-index.json','./data/questions-mf1074.json','./data/question-evidence.json','./data/progress-schema.json','./manuals.html','./manuals.css','./manuals.js'];
